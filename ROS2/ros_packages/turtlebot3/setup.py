...
data_files.append(('share/' + package_name + '/resource', ['resource/simonwilmots_turtlebot3.urdf', 'resource/ros2control.yaml', 'resource/simons_new_map.pgm', 'resource/simons_new_map.yaml']))
